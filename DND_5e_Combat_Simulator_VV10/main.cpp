...
void zombie(float &, short, short, short, short, short, short, string, string, string,short &,short &,short &,short &,unsigned short, unsigned short,short &,bool &); //the fight with the zombie. Intakes health (reference) and ability scores.
...
int main(int argc, char** argv) {
    ...
    switch(choice){
        case '1':
            ...
            if(chest[0][0]==4){ //a roll of 4 creates a Mimic.
                cout << "As you attempt to lift the lid, the chest jerks itself open to reveal a mouthful of serrated teeth.\n";
                //Insert mimic function here.
            }
            else{
                cout << "You open the chest and find some loot.\n";
                //3, 2, and 1 will give different loot tables. They will be specific to each class.
                //for example, fighters can find healing kits or arrows, and wizards can find spell slots.
                //Make 3rd level slots a bit harder to get though.
            }
            break;
        case '2':
            cout << "You choose chest B.\n"; //once case 1's loot is filled out, copy it to these other three. Make some chests
                                             //have higher chances to give you the tier 3 loot.
            break;
        case '3':
